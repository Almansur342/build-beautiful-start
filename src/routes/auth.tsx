...
export const Route = createFileRoute("/auth")({
  head: () => ({
    meta: [
      { title: "Sign in — Qrinux LeadLens" },
      { name: "description", content: "Sign in or create an account to manage your Qrinux LeadLens API keys and scans." },
      { property: "og:title", content: "Qrinux LeadLens — Sign in" },
      { property: "og:description", content: "Sign in to your Qrinux LeadLens dashboard." },
    ],
  }),
  component: AuthPage,
});
      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white border border-slate-200 rounded-2xl p-8 shadow-sm">
          ...
          <p className="text-sm text-slate-500 mb-6">
            {mode === "signin" ? "Access your API keys and scan dashboard." : "Start with 100 free scans per day."}
          </p>
          ...
          <div className="space-y-2 mb-4">
            ...
            <Button variant="outline" className="w-full h-11" onClick={() => handleOAuth("apple")}>
          ...
          <p className="mt-6 text-center text-sm text-slate-500">
            ...
            <button onClick={() => setMode(mode === "signin" ? "signup" : "signin")} className="text-slate-900 font-medium hover:underline">
